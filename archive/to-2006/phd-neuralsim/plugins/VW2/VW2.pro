...
CONFIG -= qt
CONFIG += dll opengl warn_on stl exceptions rtti 
...
HEADERS += Consts.h Eye.h Entity.h VirtualView.h VirtualWorld.h

SOURCES	+= Eye.cpp Entity.cpp VirtualView.cpp VirtualWorld.cpp
