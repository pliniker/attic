...
LIBS += -L$${PREFIX}/lib -L$${PREFIX}/plugins -lbrainlib -lnavigator -lSynapticMap -lxml2 -lz -lpthread -lm -lboost_signals
...
SOURCES	+= HebbianSynapticLayer.cpp
HEADERS += Correlation.hpp
